...
/**
 * POST /idea89/checkout/address
 * Body: {email, firstname, lastname, street, city, postcode, country_id,
 *        telephone, region?, region_id?, form_key}
 *
 ...
 * (30/session/10min), same as Context and Method — only Place gets the
 * tighter checkPlace() ceiling, because only Place spends money.
 */
class Address implements HttpPostActionInterface, CsrfAwareActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            return $result->setData($this->facade->setAddress($payload));
            ...
            $this->logger->error('[idea89] native checkout address failed', ['exception' => $e]);
